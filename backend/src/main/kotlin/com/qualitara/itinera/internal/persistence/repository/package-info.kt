/**
 * Internal repository classes that own SQL execution, row mapping, and persistence shape
 * for onboarding sessions, step states, partner accounts, and validation attempts.
 *
 * ## What repositories own
 * - SQL statement execution via [org.springframework.jdbc.core.namedparam.NamedParameterJdbcTemplate]
